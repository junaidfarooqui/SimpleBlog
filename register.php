...
<body>
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="javascript:;" class="logo d-flex align-items-center w-auto">
                  <span class="d-none d-lg-block">News Blog Admin</span>
                </a>
              </div><!-- End Logo -->
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form action="./includes/submit-register.php" method="post" class="row g-3 needs-validation" novalidate>
                      <div class="col-12">
  ...
  <?php require_once ('./admin/includes/footer-scripts.php'); ?>
</body>
